    ...
    return (
        <nav className="absolute top-0 left-0 w-full z-20 flex justify-between items-center p-6 md:p-8">
            <div className="flex items-center space-x-2">
                 <Image src="/nailart.png" alt="NailArt AI Logo" width={32} height={32} />
                 <span className="text-white font-medium tracking-wide text-lg">NailArt</span>
            </div>
            ...
            <a href="/auth" className="flex items-center justify-center px-4 py-2 bg-white/10 border border-white/20 rounded-full text-sm font-medium text-white/80 hover:text-white hover:bg-white/20 transition-all duration-300">
               GET STARTED
            </a>
        </nav>
    )
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-4">
            <div className="max-w-4xl w-full text-center space-y-8">
                ...
                <p className="max-w-2xl mx-auto text-lg md:text-xl text-white/60 font-light leading-relaxed">
                    YouTube 썸네일 제작을 위한 강력한 AI. 독창적이고 시선을 사로잡는 썸네일을 몇 초 만에 만드세요.
                </p>
                ...
                <div className="pt-8 pointer-events-auto">
                    <button className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white text-black rounded-full font-bold tracking-wide overflow-hidden transition-transform hover:scale-105 active:scale-95">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 relative z-10 group-hover:translate-x-1 transition-transform">
                            <path d="M5 12h14" />
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden selection:bg-blue-500 selection:text-white font-titan-one">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/30 animate-pulse pointer-events-none">
         <span className="text-[10px] uppercase tracking-[0.2em]">탐색하기</span>
